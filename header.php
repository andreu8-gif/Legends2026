      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            <img src=" /assets/avatar/<?php echo $avatar;?>" alt="Profile" class="rounded-circle" style="width: 36px; height: 36px;">
            <span class="d-none d-md-block dropdown-toggle ps-2"><?php echo $nickname;?></span>
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="simulador.php">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="https://www.uefa.com/euro2024/fixtures-results" target="_blank">
