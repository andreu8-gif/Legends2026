                    ...
                    <div class="row  justify-content-between">
                        ...
                        <div class="col-7  text-end">
                            <div class="row justify-content-end">
                                <div class="col-auto">
                                    <label class="d-none d-md-block form-check-label text-primary fw-bold pe-3" style="color: #012970;" for="flexSwitchCheckChecked">Ver pronósticos</label>
                                    <label class="d-md-none form-check-label text-primary fw-bold pe-3" for="flexSwitchCheckChecked"><i class="bi bi-speedometer me-1"></i></label>
                                </div>
                                ...
                                <!-- /* onClick="MostrarResultado();"> -->
                                    <label class="d-none d-md-block form-check-label text-danger fw-bold" for="flexSwitchCheckChecked">Ver resultados</label>
                                    <label class="d-md-none form-check-label text-danger fw-bold" for="flexSwitchCheckChecked"><i class="bi bi-trophy-fill me-1"></i></label>
                                </div>
                            </div>
                        </div>
                    </div>
